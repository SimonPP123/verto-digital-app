  ...
  return (
    <React.Fragment>
      <div className="flex">
        ...
        {/* Main content */}
        <div className="flex-1 max-w-4xl py-12 px-4">
          ...
          <form onSubmit={(e) => {
            ...
            <div>
              ...
              <textarea
                ...
                placeholder="Enter the content of your landing page"
                rows={4}
                required
                className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 text-gray-900 placeholder-gray-500"
              />
            ...
            <div>
              ...
              <textarea
                ...
                id="content_material"
                placeholder="Enter any additional content material"
                rows={4}
                className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 text-gray-900 placeholder-gray-500"
              />
            </div>
            ...
            <div>
              ...
              <textarea
                ...
                placeholder="Enter any internal knowledge or company-specific information"
                rows={3}
                className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 text-gray-900 placeholder-gray-500"
              />
            </div>
        ...
        <div className="w-80 min-h-screen border-l bg-gray-50">
          <div className="p-4 border-b bg-white">
